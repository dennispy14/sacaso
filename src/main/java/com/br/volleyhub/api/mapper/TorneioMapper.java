...
public interface TorneioMapper {
    ...
    @Mapping(target = "id", ignore = true)
    TournamentConfig toEntity(com.br.volleyhub.api.dto.torneio.TournamentConfigDTO dto);

    @Mapping(target = "id", ignore = true)
    GameRules toEntity(com.br.volleyhub.api.dto.torneio.TournamentConfigDTO.GameRulesDTO dto);

    @Mapping(target = "id", ignore = true)
    TournamentPhase toEntity(com.br.volleyhub.api.dto.torneio.TournamentConfigDTO.TournamentPhaseDTO dto);

    @Mapping(target = "id", ignore = true)
    GroupConfig toEntity(com.br.volleyhub.api.dto.torneio.TournamentConfigDTO.GroupConfigDTO dto);

    @Mapping(target = "id", ignore = true)
    SeriesConfig toEntity(com.br.volleyhub.api.dto.torneio.TournamentConfigDTO.SeriesConfigDTO dto);
